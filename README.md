...
234 mJ/frame, 0.8296 - the best point on the chart. Story in [`docs/findings.md`](docs/findings.md).
...
(QAT v4: 234 vs 632 mJ/frame) for −0.4 mIoU point. Same model, opposite conclusion from the
